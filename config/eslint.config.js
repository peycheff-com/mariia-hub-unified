...
export default tseslint.config(
  { ignores: ["dist", "build", "node_modules", "coverage", "*.config.js", "*.config.ts", ".storybook", "tailwind.config.*"] },
  {
    extends: [
    ...
    rules: {
      ...
      // Naming Conventions - Enforce PascalCase for components
  ...
  // Configuration files - relax naming conventions
  {
    files: ["**/tailwind.config.*", "**/vite.config.*", "**/*.config.ts"],
    rules: {
