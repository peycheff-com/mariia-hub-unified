...
const getRouteSEOConfig = (pathname: string, t: any): RouteSEOConfig | null => {
  const routes: Record<string, (t: any) => RouteSEOConfig> = {
    '/': () => ({
      title: t('seo.home.title', 'Mariia Hub - Premium Beauty & Fitness Services in Warsaw'),
      description: t('seo.home.description', 'Discover luxury beauty treatments and personalized fitness programs at Mariia Hub. Book your appointment today for expert services in Warsaw.'),
    ...
    '/beauty': () => ({
      title: t('seo.beauty.title', 'Beauty Services Warsaw - Premium Treatments | Mariia Hub'),
    ...
    '/beauty/services': () => ({
      title: t('seo.beautyServices.title', 'All Beauty Services | Mariia Hub Warsaw'),
    ...
    '/fitness': () => ({
      title: t('seo.fitness.title', 'Fitness Programs Warsaw - Personal Training | Mariia Hub'),
    ...
    '/fitness/programs': () => ({
      title: t('seo.fitnessPrograms.title', 'Fitness Programs & Classes | Mariia Hub'),
    ...
    '/about': () => ({
      title: t('seo.about.title', 'About Mariia Hub - Our Story & Philosophy'),
      description: t('seo.about.description', 'Learn about Mariia Hub\'s philosophy, our expert team, and our commitment to providing premium beauty and fitness services in Warsaw.'),
      keywords: 'about Mariia Hub, beauty salon Warsaw, fitness center, our team, our philosophy',
      ogType: 'website'
    }),
    '/contact': () => ({
      title: t('seo.contact.title', 'Contact Mariia Hub - Book Your Appointment'),
      description: t('seo.contact.description', 'Get in touch with Mariia Hub for premium beauty and fitness services in Warsaw. Book your appointment or inquire about our treatments.'),
      keywords: 'contact Mariia Hub, book appointment, beauty salon contact, fitness center Warsaw, phone, email',
      ogType: 'website'
    }),
    '/blog': () => ({
      title: t('seo.blog.title', 'Beauty & Fitness Blog - Tips & Trends | Mariia Hub'),
      description: t('seo.blog.description', 'Discover the latest beauty tips, fitness trends, treatment guides, and wellness advice from Mariia Hub experts in Warsaw.'),
      keywords: 'beauty blog, fitness tips, wellness advice, treatment guides, beauty trends Warsaw',
      ogType: 'website'
    }),
    '/reviews': () => ({
      title: t('seo.reviews.title', 'Customer Reviews & Testimonials | Mariia Hub'),
      description: t('seo.reviews.description', 'Read authentic reviews and testimonials from our satisfied clients. Discover why Mariia Hub is the top choice for beauty and fitness services in Warsaw.'),
      keywords: 'customer reviews, testimonials, beauty salon reviews, fitness center reviews, Mariia Hub feedback',
      ogType: 'website',
      structuredDataType: 'localBusiness'
    }),
    '/book': () => ({
      title: t('seo.booking.title', 'Book Your Appointment - Mariia Hub Warsaw'),
      description: t('seo.booking.description', 'Book your beauty or fitness appointment online at Mariia Hub. Easy scheduling for premium services in Warsaw.'),
      keywords: 'book appointment, online booking, beauty services booking, fitness programs booking, Warsaw appointments',
      ogType: 'website'
    }),
    '/packages': () => ({
      title: t('seo.packages.title', 'Service Packages & Deals | Mariia Hub Warsaw'),
    ...
    '/gallery': () => ({
      title: t('seo.gallery.title', 'Photo Gallery - Our Work | Mariia Hub'),
      description: t('seo.gallery.description', 'Browse our gallery showcasing beautiful transformations, fitness results, and studio environment. See the quality of our work at Mariia Hub Warsaw.'),
      keywords: 'photo gallery, beauty transformations, fitness results, before after, our work Warsaw',
      ogType: 'website'
    }),
    '/faq': () => ({
      title: t('seo.faq.title', 'Frequently Asked Questions | Mariia Hub'),
      description: t('seo.faq.description', 'Find answers to common questions about our beauty treatments, fitness programs, booking process, and services at Mariia Hub Warsaw.'),
  ...
  if (pathname.startsWith('/beauty/services/')) {
    return {
      title: t('seo.beautyServiceDetail.title', 'Beauty Service Details | Mariia Hub Warsaw'),
  ...
  if (pathname.startsWith('/fitness/programs/')) {
    return {
      title: t('seo.fitnessProgramDetail.title', 'Fitness Program Details | Mariia Hub Warsaw'),
  ...
  if (pathname.startsWith('/blog/')) {
    return {
      title: t('seo.blogPost.title', 'Blog Post | Mariia Hub'),
  ...
  if (pathname.startsWith('/lp/')) {
    return {
      title: t('seo.landingPage.title', 'Special Offer | Mariia Hub Warsaw'),
...
export const SEOWrapper: React.FC<SEOWrapperProps> = ({
  ...
  const additionalMeta = useMemo(() => {
    ...
    // Add author meta
    meta.push({ name: 'author', content: 'Mariia Hub' });
