...
import { notification aria-live="polite" aria-atomic="true"Service } from '@/services/notification.service';
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="notification aria-live="polite" aria-atomic="true"s" className="space-y-6">
        <TabsList className="grid w-full grid-cols-3">
          <TabsTrigger value="notification s">{t('user.notifications.tabs.notification aria-live="polite" aria-atomic="true"s')}</TabsTrigger>
        ...
        <TabsContent value="notification s" className="space-y-4">
