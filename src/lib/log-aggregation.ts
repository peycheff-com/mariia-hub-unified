 ...
 * Centralizes log collection, processing, and analysis for the Mariia Hub platform
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 20px; background: #f0f0f0; text-align: center;">
          <p style="margin: 0; color: #666;">
            This alert was generated by Mariia Hub Log Monitoring
          </p>
        </div>
      </div>
    `;
  ...
  private async sendSlackAlert(webhookUrl: string, alert: any): Promise<void> {
    ...
    const payload = {
      attachments: [{
        ...
        footer: 'Mariia Hub Log Monitoring',
